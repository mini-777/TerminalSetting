    ...
    while ((c = wgetch(my_menu_win)) != KEY_F(1)) {
        switch (c) {
            ...
            case 10: /* Enter key */
            {
                ...
                const char *cur_item_name = item_name(cur_item);

                if (strcmp(cur_item_name, "Toggle Echo") == 0) {
                    toggle_echo();
                } else if (strcmp(cur_item_name, "Canonical Mode") == 0) {
                    set_canonical_mode();
                } else if (strcmp(cur_item_name, "Non-canonical Mode") == 0) {
